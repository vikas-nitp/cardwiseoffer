    ...
    <div className="bg-card rounded-2xl border border-border border-t-2 border-t-primary/50 card-shadow p-8 md:p-10">
      ...
      <div className="space-y-3">
        <a
          ...
          className="flex items-center gap-4 p-4 rounded-xl bg-muted/40 border border-border hover:border-primary/30 hover:bg-muted/60 transition-all duration-150 group"
        >
